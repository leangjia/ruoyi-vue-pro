...
function CamelToSnake {
    ...
    # Replace uppercase with _lowercase
...
Get-ChildItem -Recurse -Filter "*.java" -Path $SourceDir | ForEach-Object {
    ...
    $createTable = "CREATE TABLE IF NOT EXISTS $tableName (`n"
    $createTable += ($colDefs -join ",`n")
    $createTable += "`n) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='$tableName';"
